...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    //publish maju
    public void publishMaju(Connection connection, String topic, String message, int qos, boolean retain) {
    ...
    //publish mundur
    public void publishMundur(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
    ...
    //publish kiri
    public void publishKiri(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
    ...
    //publish kanan
    public void publishKanan(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
    ...
    public void publishDiagataska(Connection connection, String topic, String message, int qos, boolean retain) {
        ...
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("diag1", message.getBytes(), qos, retain, null, callback);
    }

    //publish diagbawahka
    public void publishDiagbawahka(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("diag2", message.getBytes(), qos, retain, null, callback);
    }

    //publish diagbawahki
    public void publishDiagbawahki(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("diag3", message.getBytes(), qos, retain, null, callback);
    }
    //publish diagataski
    public void publishDiagataski(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("diag4", message.getBytes(), qos, retain, null, callback);
    }

    //publishstop
    public void publishStop(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("stopsss", message.getBytes(), qos, retain, null, callback);
    }

    public void bar1(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("servobar1", message.getBytes(), qos, retain, null, callback);
    }

    public void bar2(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("servobar2", message.getBytes(), qos, retain, null, callback);
    }

    public void bar3(Connection connection, String topic, String message, int qos, boolean retain) {
        String[] actionArgs = new String[2];
        actionArgs[0] = message;
        actionArgs[1] = topic;
        final ActionListener callback = new ActionListener(this, ActionListener.Action.PUBLISH, connection, actionArgs);
        connection.getClient().publish("servobar3", message.getBytes(), qos, retain, null, callback);
    }
